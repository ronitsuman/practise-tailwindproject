...
const Body = () => {
  return (
    <div className="space-y-4 lg:flex  ">
      <div className="flex item-centre justify-around lg:flex-1 lg:h-[400px] lg:order-2 ">
        <img src="./src/assets/Blue-Shape.svg" alt="1st" className="-rotate-45  h-64 md:h-80 lg:h-[400px] "/>
        <img src="./src/assets/Pink-Shape.svg" alt="2nd
        " 
        className=" md:h-80 absolute -rotate-[15deg] h-64 md:h-80 lg:h-[400px] "/>
        <img src="./src/assets/Purple-Shape.svg" alt="3rd" className="absolute -rotate-[30deg] h-64 md:h-80 lg:h-[400px] "  />
        <img src="./src/assets/Hero-Model.png" alt="hero" className="absolute h-64 md:h-80 lg:h-[400px] "   />
        </div>
